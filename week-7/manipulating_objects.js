...
At first I had trouble passing delete eyeColor, because I didnt' know about the delete keyword. It also took me a second to figure out that I could create objects within other objects just using dot notation instead of trying to create them as variables and then assigning them within each other. 

How difficult was it to add and delete properties outside of the object itself?
Not hard at all once I had the right function for the job.

What did you learn about manipulating objects in this challenge?
I learned to pay attention to how useful dot notation is, and how it helps keep track of where within nested objects one is. 
